...
public class ListAdapter extends BaseExpandableListAdapter {
    ...
    public ListAdapter(Context context, ArrayList<Category> parent, ExpandableListView accordion) {
        mParent = parent;
    ...
    @Override
    /**
     * automatically collapse last expanded group - we may not want this to happen!
